  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full bg-white text-black-500 px-6 lg:px-16 md:py-3 lg:py-0 flex justify-between gap-2 items-center z-10">
        ...
        <div className="md:max-w-[20%] lg:max-w-none">
          <Link to="/">
            <img
              ...
              alt="logo"
              className="md:max-w-[100%] lg:max-w-none"
            />
          </Link>
        </div>
        ...
        <div
          ref={navRef}
          className="hidden md:flex justify-center flex-1 px-3 lg:px-1"
        >
          <NavLinks
        ...
        <div className="hidden md:flex lg:items-center md:flex-col lg:flex-row gap-1">
          {/* Existing buttons */}
      ...
      {/* Mobile Sidebar */}
      <aside
        className={`fixed top-0 left-0 w-64 h-full bg-white text-black-500 transform ${
